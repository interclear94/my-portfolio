      ...
      <div className="w-full flex flex-col justify-center items-center py-30">
        <div className="w-[95%] flex gap-x-10 sm:flex-col sm:justify-center sm:items-center">
          ...
          <div className="w-full pb-1 pt-10">
            ...
            <div className="text-[1.2rem] text-white bg-gray-700 sm:px-8 sm:py-7 rounded-xl">
              <ul className="grid sm:grid-rows-3 sm:grid-cols-2 sm:text-[0.95rem] sm:font-semibold">
                ...
                <li className="flex gap-x-6">
                  ...
                  <div className="flex flex-col">
                    <span>이메일</span> <span>jakapark94@naver.com</span>
                  </div>
                </li>
              </ul>
              <ul className="w-full border-gray-500 sm:flex sm:border-t-2 sm:pt-4">
                <li className="w-1/2 flex sm:gap-x-2 sm:justify-center">
                  <a
